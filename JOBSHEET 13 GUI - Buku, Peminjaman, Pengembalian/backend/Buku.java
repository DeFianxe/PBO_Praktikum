...
public class Buku {
    ...
    private String judul; private String penerbit; 
    ...
    { 
        ...
        { 
            String SQL = "UPDATE buku SET " 
                    ...
                    + this.penerbit + "' " + " WHERE idbuku = '" 
                    + this.idbuku + "'"; DBHelper.executeQuery(SQL); 
        } 
    } 
    ...
    public Buku getByJudul(String judul) {
        Buku buku = null;
        ResultSet rs = DBHelper.selectQuery("SELECT * FROM buku WHERE judul LIKE '%" + judul + "%'");
    ...
    public Buku getByTitle(String title) {
        return getByJudul(title); // Alias untuk konsistensi
    }
