...
public class Anggota {
    ...
    public Anggota getByName(String Anggota) {
        Anggota anggota = null;
        ResultSet rs = DBHelper.selectQuery("SELECT * FROM anggota WHERE nama = '" + Anggota + "'");
    ...
    public Anggota getByFullName(String fullName) {
